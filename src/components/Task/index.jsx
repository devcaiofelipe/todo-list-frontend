...
const Task = ({ taskId, description, checked, handleCheckTask, handleTaskToDelete, handleTaskIdToUpdate }) => {
  return (
    <li key={taskId} className="task-container" style={ checked ? { borderStyle: 'solid', borderWidth: '2px', borderColor: 'red' } : null }>
      ...
      <div>
        <button className="task-container-button update-button" onClick={() => handleTaskIdToUpdate(taskId)}><BsPencil/></button>
